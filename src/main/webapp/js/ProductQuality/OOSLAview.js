...
$(drawChart=function () {
	...
	function columnClick(event){
		...
		$.ajax({
				...
				data:'domain='+domain+'&priority='+priority+'&status=NotClosed'+'&isOOSLA=total'+'&severity='+severity,
	...
	$.each(names,function(i,name){
		$.getJSON('ProductionQuality!OOSLA.action?domain='+domain+'&priority='+priority,function(data){
